 ...
 //delete
  ...
  const handleSaveButton = () => {
    ...
    if (templateName && user && user.id && previewContent) {
      axios.post(`${apiConfig.baseURL}/api/stud/birthtemplate`, { 
...
const sendscheduleEmail = async () => {
  ...
  const sendEmail = async () => {
    ...
    try {
     ...
     // Send emails sequentially using a for loop
          ...
          <nav className="navbar">
            <div>
              <h3 className="company-name">
                ...
                <span style={{ color: "#f48c06" }}>Birthday Campaign</span>
              </h3>
            </div>
            <div>
              <button
        ...
        <div className="Mobile-nav">
          <nav className="navbar">
            <div className="navbar-header">
              <h3 className="company-name">
                <span style={{ color: "#2f327D", fontSize: "18px" }}>
                  Birthday Remainder
                </span>
                <span
                  style={{
