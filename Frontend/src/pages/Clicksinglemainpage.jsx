...
const sendscheduleEmail = async () => {
  ...
  if (!emailData || !singleemails.length || !emailData.subject || !emailData.previewtext || !aliasName || !replyTo || !scheduledTime) {
...
if (!campaignName.includes("IndividualClick-Retarget")) {
  ...
  const sendEmail = async () => {
    ...
    if (!emailData || !singleemails.length || !emailData.subject || !emailData.previewtext || !aliasName || !replyTo) {
      toast.warning("Please fill in all required fields.");
      return;
    }
